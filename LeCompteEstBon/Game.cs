...
namespace LeCompteEstBon
{
    class Game
    {
        ...
        public void Start()
        {
            ...
            Console.WriteLine("Pour réinitialiser les calculs, entré la valeur 'r'");
        ...
        public void Menu()
        {
            ...
            if(int.TryParse(answer, out intAnswer))     //Check if the answer is an int
            {
                switch (intAnswer)
                {
                    case 1:
        ...
        public void ChooseCalcul(Result r)
        {
            ...
            do
            {
                ...
                {
                    String pattern = @"(\d+)([-+*/])(\d+)";     //Define a pattern for the user answer
        ...
        public void NewCalcul(int a, int b, string c, Result r)
        {
            ...
            //Remove the elements from the object list
            r.RemoveNb(a);
            r.RemoveNb(b);
        }
